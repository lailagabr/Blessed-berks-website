...
<div class="content">
            <?php
                ...
                <div class="card">
                    <div class="product">
                        ...
                        <div class="second">
                            <h5 class="card-title"><?php echo  ($data['product_price']. " egp"); ?></h5>
                            

                        </div>
                        <a  style="border-color: orange;"class="btn btn-light" href="add_to_cart.php?remove=<?php echo($data['id']); ?>">Remove</a>
            ...
            <div class="card cbtn">
                <a href="#" class="btn btn-light"style="border-color: orange;">check out</a>
            </div>
...
<footer>
        <div class="left">
            <h1>Blissed Berks</h1>
            <p>your premier source for top-quality pet supplies! <br> Discover everything your furry friends need from <br> food to toys and more.
                Explore our curated selection <br> and join a community passionate about providing the <br> best for their pets.</p>
        </div>
        <div class="services">
            <h2>services</h2>
            <a href="">Products</a>
