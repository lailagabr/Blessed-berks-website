...
//     $id=$_GET['display'];
    // $display= "SELECT * FROM `category` WHERE `category_id` = 1 ";
//     $run_display=mysqli_query($connect,$select);
//     header("location:pets cats.php");
// }
    ...
    <div class="content">
        ...
        <div class="cards1">
            ...
            <div class="card"><img class="img" src="<?php echo $image_path; ?>" alt="<?php echo ($data['product_photo']); ?>">
                ...
                <!-- <a class="cart" href="add_to_cart.php?add=<?php echo $data['product_id']; ?>" class="actionbtn">Add to cart</a> -->
            <!-- hi lolzz fix this button thank youu 3> -->
