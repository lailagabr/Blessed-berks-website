...
if(isset($_POST['submit_cat'])){
    ...
    $insert = "INSERT INTO `product` VALUES (NULL,'$name',NULL ,'$image' ,'$price'
          ...
          header('location:aproducts_cat.php');
}
//display
$category_id= 2;
...
<br>
                ...
                <!-- add button  -->
                <button type="submit" name="submit_cat" class="actionbtn2 btn-secondary btn-lg" onclick="closepopup()">add</button>
                <!--  -->
        ...
        <div class="cards1">
            ...
            <h2><?php echo $data ['product_name'] ?></h2>
                ...
                <a class="actionbtn" onclick="openpopup2()">edit</a> 
                    <a href="aproducts_cat.php?delete=<?php echo $data ['product_id']?>" class="actionbtn">delete</a>
                    <a  class="actionbtn" href="aproducts_cat.php?hide=<?php echo $data ['product_id']?>" >hide</a>
